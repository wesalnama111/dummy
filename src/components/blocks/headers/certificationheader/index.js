            ...
            <div>
                {
                    this.state.data !== null &&
                        <div>
                            <div className="genericheader" id="dtp-certification">
                                        ...
                                        <div className="middle-header-cert container">
                                            <div className="row">
                                                ...
                                                <div className="col-7 chapters">
                                                    ...
                                                    <button className="btn btn-medium btn-blue montserrat normal-text-prop tw-n pl-5 pr-5">SEE ALL certification paths</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
